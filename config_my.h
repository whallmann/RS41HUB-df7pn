...
//**************config**********************
#define CALLSIGN "DF7PN" // put your RTTY callsign here, max. 15 characters
#define APRS_CALLSIGN "DF7PN " // put your APRS callsign here, 6 characters. If your callsign is shorter add spaces
...
#define APRS_COMMENT " Funny Ballon Experiment nbr001"
#define RTTY_COMMENT " Ballon Experiment"				// max. 25 characters
#define RTTY_TO_APRS_RATIO 5 //transmit APRS packet with each x RTTY packet

//*************TX Frequencies********************
#define RTTY_FREQUENCY  433.520f //Mhz middle frequency
#define APRS_FREQUENCY  432.520f //Mhz middle frequency
